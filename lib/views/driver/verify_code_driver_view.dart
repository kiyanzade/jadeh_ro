...
import 'package:jadehro_app/widgets/national_code_widget.dart';
...
class VerifyCodeDriverView extends StatefulWidget {
  const VerifyCodeDriverView({super.key});

  @override
  State<VerifyCodeDriverView> createState() => _VerifyCodeDriverViewState();
}

class _VerifyCodeDriverViewState extends State<VerifyCodeDriverView> {
  ...
  Widget build(BuildContext context) {
    final Color borderColor = Constants.driverColor.withOpacity(0.5);
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appBarWidget(
            title: 'کد تایید', backgroundColor: Constants.driverColor),
        body: Padding(
