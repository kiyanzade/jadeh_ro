          ...
          children: [
            Expanded(
              child: PageView(
                  ...
                  children: const [
                    OnBoardText(
                      title: "به جانمونی خوش اومدی!",
                      text:
                          "جانمونی اومده تا از اربعین جانمونی کارش اینه که مسافر رو به راننده خودرو سواری برسونه تا تنها سفر نکنی",
                      image: 'assets/images/1.jpg',
                    ),
                    OnBoardText(
                      title: "راننده اید، سواری دارید!",
                      text:
                          "جانمونی برای شما مسافر میاره تا همسفر داشته باشید و و ماشینتون خالی به مقصد نرسه",
                      image: 'assets/images/2.jpg',
                    ),
                    OnBoardText(
                      title: "مسافرید ! ماشین ندارید !",
                      text:
                          "جانمونی برای شما توی مسیر سفر شما ماشین پیدا میکنه",
